...
#movies contains datasets, like training_set and training_labels which are used to train the model and validation_set and validation_labels is used to test the model
...
# the model has an accuracy of 66.4 percent